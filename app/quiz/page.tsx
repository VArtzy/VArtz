...
<a href={`href="https://wa.me/6289611905599?text=Hai%20min,%20bisa%20konsultasi%20buat%20website ${type} dengan tujuan ${tujuan}?`} className="text-emerald-50 px-4 py-2 bg-emerald-800 text-lg rounded-md">Saya tidak mengerti, konsultasi lewat whatsapp saja</a>
      <span className="text-grayweb text-sm leading-none mb-4">Kami siap membantu Anda dalam mendapatkan website terbaik yang terjangkau sesuai impian Anda</span>
                </>
            )}
