                            ...
                            >
                                <div className="flex gap-4">
                                    <a
                                        ...
                                        className="konversi_konsultasi_web inline-block text-md rounded bg-springGreen hover:bg-mediumSpringGreen transition px-4 py-2"
                                    >
                                        Buatkan Saya
                                    </a>
                                    <a
                                        href="https://wa.me/6289628196420?text=Hai%20min,%20bisa%20konsultasi%20buat%20website?"
                                        className="konversi_konsultasi_web flex items-center gap-2 text-md rounded bg-mediumSpringGreen hover:bg-SpringGreen transition px-4 py-2"
                                    >
                                        <BsWhatsapp />
                                        Konsultasi Gratis
                                    </a>
